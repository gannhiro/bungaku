...
export function MangaListRenderItemContRatIcon({contentRating, style}: Props) {
  ...
  if (contentRating === 'safe') {
    return (
      <Image
        ...
        style={[styles.coverImageOverlayIcons, safeIconStyle, style]}
      />
    );
  }
  if (contentRating === 'suggestive') {
    return (
      <Image
        ...
        style={[styles.coverImageOverlayIcons, suggestiveIconStyle, style]}
      />
    );
  }
  if (contentRating === 'erotica') {
    return (
      <Image
        source={require('@assets/icons/devil-heartv2.png')}
        style={[styles.coverImageOverlayIcons, eroticaIconStyle, style]}
      />
    );
  }
  if (contentRating === 'pornographic') {
    return (
      <Image
        source={require('@assets/icons/devil-heartv2.png')}
        style={[styles.coverImageOverlayIcons, pGraphicIconStyle, style]}
      />
    );
  }
